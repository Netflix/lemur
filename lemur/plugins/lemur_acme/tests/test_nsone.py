...
class TestNsone(unittest.TestCase):
    ...
    def test_get_zones(self, mock_current_app):
        ...
        get_response = [{
            ...
            },"records":[{"domain":"string","id":"string","short_answers":["string"],"tier":0,"ttl":0,"type":"string"}],
            "refresh":0,
            "retry":0,
            "ttl":0,
            "zone":"string",
    ...
    def test_create_txt_record_append(self, mock_current_app):
        ...
        nsone._check_conf = Mock()
        cur_token = "123456"
        cur_records = {"answers":[{"answer":["ABCDEFHG"],"id":"1234567890abcdef"}],"id":"1234567890abcdef"}
        ...
        expected_payload = {"answers": [{"answer": ["ABCDEFHG"], "id": "1234567890abcdef"}, {"answer": ["ABCDEFGHIJ"]}], "id": "1234567890abcdef"}
        result = nsone.create_txt_record(domain, token, account_number)
        mock_current_app.logger.debug.assert_called_with(log_data)
