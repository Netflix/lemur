...
def test_create_arn_from_cert():
    ...
    path = ""
    assert (
        create_arn_from_cert(
            account_number, partition_commercial, certificate_name, path
        )
        == arn
    )
    ...
    path = "cloudfront/2"
    assert (
        create_arn_from_cert(account_number, partition_gov, certificate_name, path)
        == arn
    )
    ...
    path = "cloudfront/2"
    assert (
        create_arn_from_cert(account_number, partition_cn, certificate_name, path)
        == arn
    )
