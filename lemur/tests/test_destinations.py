...
def test_destination_output_schema_redacts_sensitive_options():
    """Sensitive options must have their value set to None in serialized output."""
...
def test_destination_output_schema_preserves_non_sensitive_options():
