...
ifndef VIRTUAL_ENV
	...
	pip-compile --generate-hashes --output-file requirements.txt requirements.in -U --no-emit-index-url
	pip-compile --generate-hashes --output-file requirements-docs.txt requirements-docs.in -U --no-emit-index-url
	pip-compile --generate-hashes --output-file requirements-dev.txt requirements-dev.in -U --no-emit-index-url
	pip-compile --generate-hashes --output-file requirements-tests.txt requirements-tests.in -U --no-emit-index-url
